...
img_path = r'C:\Users\Malene\OneDrive - NTNU\Documents\NTNU\MasterThesis-2022\Code-testing\CASIA2-NEW-trainValTest-jpg\test\Tp'
dst_path = r'C:\Users\Malene\OneDrive - NTNU\Documents\NTNU\MasterThesis-2022\Code-testing\CASIA2-cmsf-jpegComp-quality90-TEST\compressed90\Tp'
...
for filename in os.listdir(img_path):
    ...
    tmp_name = os.path.join(dst_path, strip_name + 'tmp.jpg')
    print("tmp_name ", tmp_name)
    # name, ext = os.path.splitext(filename)
    original_img.save(tmp_name, 'JPEG', quality = 90)
